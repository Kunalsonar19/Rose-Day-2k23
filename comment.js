...
//   height: 100%;
//   width: 100%;
//   background: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9K8298n0XJd30OV70yIWchtNhwgL-HWXXv2ZYyBaBBa_dh26Wocoo2Eb9_ghn2RgIm6E&usqp=CAU');
...
//   letter-spacing: 1px;
//   font-size: 25px;
//   font-family: 'montez', Courier, monospace;
//   padding: 0 20px;
// }
...
// .rose+span {
//   position: absolute;
//   font-family: "Kaushan Script", san-serif;
//   font-weight: bold;
//   font-size: 18px;
//   color: #64b5ce;
...
//write a code for email validation in js